...
concerns.  Focusing on in-migration leads to concerns that Colorado is growing too fast; that the state is unprepared for significant increases in its population caused by in-migration.  On the other hand, focusing on out-migration leads to speculation that too many people are leaving Colorado, whether due to the cost of housing, a lack of well-paying jobs, or other reasons.  However, one should not consider these types of migration in isolation.  The State Demography Office analysis of recent migration patterns considers both in- and out-migration.   The larger analysis concludes that while there are differences between in-migrants and out-migrants, as there are between in-migrants and Colorado residents, and return migrants and other in-migrants, the overall impacts of recent migration do not signal major changes in Colorado’s population.
